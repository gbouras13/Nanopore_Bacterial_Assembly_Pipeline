...
#SBATCH --err="will_bact_assembly_snk.err"
...
--config csv=will_martha.csv Output=/hpcfs/users/a1667917/Will/C_Accolens_Martha_Hybrid_Assembly_Output Polypolish_Dir=/hpcfs/users/a1667917/Polypolish min_chrom_length=2000000
